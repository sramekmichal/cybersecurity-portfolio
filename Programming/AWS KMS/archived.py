"""AWS Example showing basic encryption and decryption of a value already in memory."""
...
# REPLACE KEY  ARN
cycle_string(
    key_arn="arn:aws:kms:us-east-1:000000000000:key/be30fc08-a41e-44d6-9232-735af533f1ca",
    source_plaintext="testing",
)
